...
public class duoren {
    ...
    public void test_wa1(){
        int q = (p.people2_x-p.bee_x)*(p.people2_x-p.bee_x) + (p.people2_y-p.bee_y)*(p.people2_y-p.bee_y);
        if(Math.sqrt(q)<=121){
            p.people2_x = 200;
            p.people2_y = 200;
            state_demo1 = 3;
    ...
    public void move_enemy1(){
        int move_s1 = Math.abs(p.emeny_sp_y1 - p.people2_y);
        int move_s2 = Math.abs(p.emeny_sp_y2 - p.people2_y);
        int move_s3 = Math.abs(p.emeny_sp_y3 - p.people2_y);
        int move_s4 = Math.abs(p.emeny_sp_y4 - p.people2_y);
        if(q==2){
            if(move_s1<280&&p.emeny_sp_y1 - p.people2_y > 0){
                change_x15 = 1;
                arr.set(15,0);
                k15 = 0;
                score+=100;
            }
            if(move_s2<280&&p.emeny_sp_y2 - p.people2_y > 0){
                change_x16 = 1;
                arr.set(16,0);
                k16 = 0;
                score+=100;
            }
            if(move_s3<280&&p.emeny_sp_y3 - p.people2_y > 0){
                change_x17 = 1;
                arr.set(17,0);
                k17 = 0;
                score+=100;
            }
            if(move_s4<280&&p.emeny_sp_y4 - p.people2_y > 0){
                change_x18 = 1;
                arr.set(18,0);
                k18 = 0;
                score+=100;
    ...
    public void test_enemy1(){
        int q1 = (p.people2_x-p.emeny_l_x)*(p.people2_x-p.emeny_l_x) + (p.people2_y-p.emeny_l_y)*(p.people2_y-p.emeny_l_y);
        int q2 = (p.people2_x-p.emeny_l_x1)*(p.people2_x-p.emeny_l_x1) + (p.people2_y-p.emeny_l_y1)*(p.people2_y-p.emeny_l_y1);
        int q3 = (p.people2_x-p.emeny_l_x2)*(p.people2_x-p.emeny_l_x2) + (p.people2_y-p.emeny_l_y2)*(p.people2_y-p.emeny_l_y2);
        int q4 = (p.people2_x-p.emeny_l_x3)*(p.people2_x-p.emeny_l_x3) + (p.people2_y-p.emeny_l_y3)*(p.people2_y-p.emeny_l_y3);
        int q5 = (p.people2_x-p.emeny_l_x4)*(p.people2_x-p.emeny_l_x4) + (p.people2_y-p.emeny_l_y4)*(p.people2_y-p.emeny_l_y4);
        int q6 = (p.people2_x-p.emeny_l_x5)*(p.people2_x-p.emeny_l_x5) + (p.people2_y-p.emeny_l_y5)*(p.people2_y-p.emeny_l_y5);
        int q7 = (p.people2_x-p.emeny_l_x6)*(p.people2_x-p.emeny_l_x6) + (p.people2_y-p.emeny_l_y6)*(p.people2_y-p.emeny_l_y6);
        int q8 = (p.people2_x-p.emeny_l_x7)*(p.people2_x-p.emeny_l_x7) + (p.people2_y-p.emeny_l_y7)*(p.people2_y-p.emeny_l_y7);
        int q9 = (p.people2_x-p.emeny_l_x8)*(p.people2_x-p.emeny_l_x8) + (p.people2_y-p.emeny_l_y8)*(p.people2_y-p.emeny_l_y8);
        int q10 = (p.people2_x-p.emeny_l_x9)*(p.people2_x-p.emeny_l_x9) + (p.people2_y-p.emeny_l_y8)*(p.people2_y-p.emeny_l_y8);
        int q11 = (p.people2_x-p.emeny_l_x10)*(p.people2_x-p.emeny_l_x10) + (p.people2_y-p.emeny_l_y8)*(p.people2_y-p.emeny_l_y8);
        int q12 = (p.people2_x-p.emeny_l_x11)*(p.people2_x-p.emeny_l_x10) + (p.people2_y-p.emeny_l_y8)*(p.people2_y-p.emeny_l_y8);
        if(p.end_play == 1){
            q1 = Math.abs(p.people2_x-p.emeny_l_x);
            q2 = Math.abs(p.people2_x-p.emeny_l_x1);
            q3 = Math.abs(p.people2_x-p.emeny_l_x2);
            q4 = Math.abs(p.people2_x-p.emeny_l_x3);
        }
        if(Math.sqrt(q1)<=121){
            change_x = 1;
            arr.set(1,0);
